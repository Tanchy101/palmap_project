...
const GazeboPanel612 = () => {
      return (
        <div className="gazebo-container">
          <div className='upper-part'>
            <div>
                <Link to={"/gazebo11"} className="arrow-left">
                  <div>
              ...
              <div className="gazebo-label">Gazebo 12</div>

              <div>
                <Link to={"/gazebo13"} className="arrow-right">
                  <div>
